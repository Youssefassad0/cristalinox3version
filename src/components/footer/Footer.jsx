            ...
            <ul>
              <li>
                <Link to="" target="_blank">
                  <i className="fa-solid fa-phone"></i> +212 0661471841
                </Link>
              </li>
              <li>
                <Link to="mailto:cristalinox@gmail.com" target="_blank">
                  <i className="fa-solid fa-envelope"></i> cristalinox@gmail.com
                </Link>
              </li>
